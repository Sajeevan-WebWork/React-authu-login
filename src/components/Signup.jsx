    ...
    return (
        <>
            ...
            <span className='rotating__bordor h-[50rem] border-2 w-[50rem]  border-[#dcbff947] rounded-full bg-transparent block z-10 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-4 text-white'></span>
                <span className='h-[25rem] md:h-[40rem] w-[25rem] md:w-[40rem] rounded-full bg-[#ede6f4] block z-10 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-4 text-white'></span>
                ...
                <div className="block z-20 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-4 text-white'">
                    <motion.div
                        ...
                        <form action="" onSubmit={handleSignup} className='relative w-100 flex flex-col gap-8'>
                            ...
                            <motion.div
                                ...
                                <input type="text" id="name" value={name} onChange={(e) => setName(e.target.value)} required className="block px-3 pb-3 pt-4 w-full text-base text-gray-900 bg-transparent rounded-lg border-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-[#965bc3] peer" placeholder=" " />
                                <label htmlFor="name" className="absolute text-base text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white  px-2 peer-focus:px-2 peer-focus:text-[#965bc3] peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1">Name</label>
                            </motion.div>
                            ...
                            <motion.div
                                ...
                                className="relative w-100 ">
                                <input type="text" id="email" value={email} onChange={(e) => setEmail(e.target.value)} required className="block px-3 pb-3 pt-4 w-full text-base text-gray-900 bg-transparent rounded-lg border-2 border-gray-300 appearance-none  focus:outline-none focus:ring-0 focus:border-[#965bc3] peer" placeholder=" " />
                            ...
                            <button type='submit' className='cursor-pointer hover:bg-[#7900fad8] transition-all duration-300 hover:scale-101 active:scale-105 p-4 rounded-lg bg-[#7900fa] text-white text-lg'>Signup</button>

                            {/* <a href="#" className="text-lg font-semibold text-[#965bc3] text-center">Forgot Password?</a> */}

                            <p className='text-lg font-medium text-center text-gray-400'>Already have an account? <Link to={'/login'} href="#" className='text-[#965bc3]'>Login!</Link></p>
                        </form>
                    </motion.div>
